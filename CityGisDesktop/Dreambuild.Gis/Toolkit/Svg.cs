...
{
    /// <summary>
    /// SVG生成器，是Dreambuild.Svg早期一种较底层的SVG操作方式，仅隐藏了XML操作的细节，调用者需要知道SVG的一些细节，使用此类仅仅为了调用方便。
    /// </summary>
    public class SvgWriter
    {
        ...
        public void SetSvgAttributes(string width = null, string height = null, Extents viewBox = null) // newly 20130507
        {
        ...
        public void AddPolyline(IEnumerable<Vector> points)
        {
        ...
        /// </summary>
        /// <param name="points"></param>
        public void AddPolygon(IEnumerable<Vector> points)
        {
