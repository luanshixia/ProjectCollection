...
namespace System
{
    public static class LocalExtensions
    {
        ...
        public static object GetPropertyValue(this object obj, string path) // newly 20141218
        {
...
namespace System.Linq
{
    public static class LocalExtensions
    {
        ...
        public static IEnumerable<TResult> Zip<T1, T2, TResult>(this IEnumerable<T1> first, IEnumerable<T2> second, Func<T1, T2, TResult> resultSelector) // newly 20140520
        {
