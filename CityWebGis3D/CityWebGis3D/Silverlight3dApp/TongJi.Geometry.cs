...
namespace TongJi.Geometry
{
    ...
    public struct Vector2D
    {
        ...
        {
            double angle = this.ZeroToPiAngleTo(Vector2D.PositiveXUnit);
            if (this.y < 0)
            {
        ...
        public static Vector2D PositiveXUnit
        {
            get
            {
    ...
    public class Point2DSet
    {
        ...
        public Point2DSet(List<Point2D> pts)
        {
            points = pts;
        }

        public Point2DSet(string ptStr)
        {
        ...
        public Point2DSet GetOffset(double offset)
        {
            ...
            Point2DSet ptSet = new Point2DSet(listPt);
            return ptSet;
        }
    ...
    public class Polyline : Point2DSet
    {
        ...
        public Point2D Centroid
        {
            get
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    Vector2D v1 = points[i] - new Point2D(0, 0);
                    Vector2D v2 = points[j] - new Point2D(0, 0);
                    temp += v1.ScalarCross(v2) / 3.0 * (v1 + v2 + Vector2D.Zero);
    ...
    public class Extent2D
    {
        ...
        public static Extent2D Null { get { return new Extent2D(); } }
        ...
        public bool IsPointSetIn(Point2DSet pSet)
        {
            double delta = 0.1;
        ...
        public bool IsPointSetCross(Point2DSet pSet)
        {
            double delta = 0.1;
            for (double d = 0; d < pSet.Count - 1 + delta; d += delta)
            {
