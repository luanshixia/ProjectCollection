        ...
        private class SimpleMembershipInitializer
        {
            public SimpleMembershipInitializer()
            {
                ...
                try
                {
                    ...
                    WebSecurity.InitializeDatabaseConnection("WebBasicsConnection", "UserProfile", "UserId", "UserName", autoCreateTables: true);
                    if (!WebSecurity.UserExists("root"))
                    {
                        WebSecurity.CreateUserAndAccount(userName: "root", password: "root123");
